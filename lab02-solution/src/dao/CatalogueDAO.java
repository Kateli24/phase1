...
public class CatalogueDAO {
	...
	static {
		if (items.isEmpty()) {
			items.put("WD1234", new Product("WD1234", "Green Widget", "A widget that has gone mouldy.", "Widgets", new BigDecimal("21.43"), "http://localhost:8080/api/catalogue/product/WD1234"));
			items.put("DH8832", new Product("DH8832", "Dodgy Doohicky", "A doohicky that might work, or it might not...", "Doohickies", new BigDecimal("12.32"), "http://localhost:8080/api/catalogue/product/DH8832"));
		}
	}
